...
extern "C" void * vtkCylindricalTransform_get_ptr (vtkCylindricalTransform * sself) ;
...
extern "C" void * vtkGeneralTransform_get_ptr (vtkGeneralTransform * sself) ;
...
extern "C" void * vtkIdentityTransform_get_ptr (vtkIdentityTransform * sself) ;
...
extern "C" void * vtkLandmarkTransform_get_ptr (vtkLandmarkTransform * sself) ;
...
extern "C" void * vtkMatrixToHomogeneousTransform_get_ptr (vtkMatrixToHomogeneousTransform * sself) ;
...
extern "C" void * vtkMatrixToLinearTransform_get_ptr (vtkMatrixToLinearTransform * sself) ;
...
extern "C" void * vtkPerspectiveTransform_get_ptr (vtkPerspectiveTransform * sself) ;
...
extern "C" void * vtkSphericalTransform_get_ptr (vtkSphericalTransform * sself) ;
...
extern "C" void * vtkThinPlateSplineTransform_get_ptr (vtkThinPlateSplineTransform * sself) ;
...
extern "C" void * vtkTransform_get_ptr (vtkTransform * sself) ;
...
extern "C" void * vtkTransform2D_get_ptr (vtkTransform2D * sself) ;
...
extern "C" void * vtkTransformCollection_get_ptr (vtkTransformCollection * sself) ;
